...
header{
  ...
  background:#111;
  border-radius:10px;border:none;border-bottom:3px solid #FDB827;
}
header::before{display:none}
.brand{display:flex;align-items:center;gap:8px}.ball-svg{display:none}
.brand-text h1{
  font-size:1.4rem;font-weight:900;letter-spacing:1px;line-height:1;color:#FDB827;
}
...
function renderPropsSection(picks, nopick) {
  ...
  order.forEach(function(matchup,mi){
    ...
    html+='<span style="font-weight:900;color:#fff;font-size:.85rem">🏀 '+matchup+'</span><span style="background:rgba(253,184,39,.15);border:1px solid rgba(253,184,39,.3);color:#FDB827;padding:2px 8px;border-radius:20px;font-size:.75rem">'+gp.length+' props ▾</span></div>';
