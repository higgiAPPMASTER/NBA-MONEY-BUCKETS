...
.pick-card:hover{border-color:rgba(253,184,39,.55);transform:translateY(-3px);box-shadow:0 8px 30px rgba(0,0,0,.6),0 0 20px rgba(253,184,39,.2)}
...
.compact-row{
  ...
  background:#222;border:1px solid #333;border-radius:10px;padding:10px 15px;
...
<div class="hdr">
  <h1>NBA <span>Money</span> Buckets</h1>
</div>
