...
<nav style="position:fixed;top:0;width:100%;background:rgba(10,10,10,.95);backdrop-filter:blur(12px);border-bottom:1px solid #1c1c1c;z-index:100;padding:0 28px;height:72px;display:flex;align-items:center;justify-content:space-between"><span style="font-family:'Playfair Display',serif;font-size:1.5rem;font-weight:900;color:#f59e0b">Money<span style="color:#fff">Buckets</span> 🏀</span><div style="display:flex;align-items:center;gap:10px"><input type="date" id="datePicker" value="__TODAY__" style="background:#161616;color:#f59e0b;border:1px solid #262626;border-radius:8px;padding:7px 12px;font-size:.82rem;font-weight:600;outline:none;cursor:pointer;font-family:'Source Sans Pro',sans-serif;"><button class="btn btn-run" onclick="runPicks()">⚡ Run Picks</button></div></nav>
